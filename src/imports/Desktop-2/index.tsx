import svgPaths from "./svg-wraff2n6ln";
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start leading-[0] relative shrink-0 text-[#2c4a2e] w-full" data-name="question + explainer">
      <div className="flex flex-col font-['Playfair_Display:Medium',sans-serif] font-medium justify-center relative shrink-0 text-[20px] text-center whitespace-nowrap">
        <h1 className="block leading-[28px]">{`What's your biggest concern about transitioning?`}</h1>
      </div>
      <div className="flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center min-w-full relative shrink-0 text-[16px] w-[min-content]">
        <h1 className="block leading-[24px]">Be honest — this shapes the guidance we give you.</h1>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch cursor-pointer flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="choices">
      ...
      <button className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Radio Button">
        <RadioButton1 />
        <div className="[word-break:break-word] flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#1a1a18] text-[16px] text-left whitespace-nowrap">
          <p className="leading-[24px]">I have debt tied to my current operation</p>
        </div>
      </button>
      <button className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Radio Button">
        <RadioButton2 />
        <div className="[word-break:break-word] flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#1a1a18] text-[16px] text-left whitespace-nowrap">
          <p className="leading-[24px]">I don’t know what I’d grow instead</p>
        </div>
      </button>
      <button className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Radio Button">
        <RadioButton3 />
        <div className="[word-break:break-word] flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#1a1a18] text-[16px] text-left whitespace-nowrap">
          <p className="leading-[24px]">Family or community pressure</p>
        </div>
      </button>
      <button className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Radio Button">
        <RadioButton4 />
        <div className="[word-break:break-word] flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#1a1a18] text-[16px] text-left whitespace-nowrap">
          <p className="leading-[24px]">I don’t know where I’d sell my crops</p>
        </div>
      </button>
      <button className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Radio Button">
        <RadioButton5 />
        <div className="[word-break:break-word] flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#1a1a18] text-[16px] text-left whitespace-nowrap">
          <p className="leading-[24px]">Something else</p>
        </div>
      </button>
    </div>
  );
...
function Ctas() {
  return (
    <div className="content-stretch flex gap-[40px] items-start justify-center relative shrink-0" data-name="ctas">
