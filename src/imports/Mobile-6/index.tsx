import svgPaths from "./svg-fqj0vsho55";
...
function CreateAccountCta() {
  return (
    <div className="[word-break:break-word] content-stretch flex font-['Source_Sans_3:Regular',sans-serif] font-normal gap-[6px] items-start justify-center leading-[0] relative shrink-0 text-[#f5f0e8] text-[14px] text-center w-full whitespace-nowrap" data-name="create account cta">
      <div className="flex flex-col justify-center relative shrink-0">
        <p className="leading-[22px]">Don’t have an account yet?</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0">
        <p className="[text-underline-position:from-font] decoration-from-font decoration-solid leading-[22px] underline">Start your assessment</p>
      </div>
    </div>
  );
}
...
function CtaSection() {
  return (
    <div className="bg-[#2c4a2e] content-stretch flex flex-col gap-[24px] items-center overflow-clip p-[32px] relative rounded-[16px] shrink-0 w-[343px]" data-name="cta section">
      ...
      <div className="[word-break:break-word] flex flex-col font-['Playfair_Display:Medium',sans-serif] font-medium justify-center leading-[0] min-w-full relative shrink-0 text-[#f5f0e8] text-[24px] text-center w-[min-content]">
        <p className="leading-[32px]">Pick up right where you left off.</p>
      </div>
