import svgPaths from "./svg-bhcd57nqc6";
import imgLogoGreen1 from "./4bbb69a71a9c77bc7e7a2edf944709e6282e2e0e.png";

function Map() {
  return (
    <div className="h-[232px] relative rounded-[16px] shrink-0 w-full" data-name="Map">
      <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
        <div className="h-[232px] relative shrink-0 w-full" data-name="Embed">
...
function HeadSubhead() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[2px] items-start leading-[0] relative shrink-0 text-[#2c4a2e] text-center w-full whitespace-nowrap" data-name="head + subhead">
      <div className="flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[20px]">
        <h1 className="block leading-[28px]">Assessing farmland in</h1>
      </div>
      <div className="flex flex-col font-['Playfair_Display:Medium',sans-serif] font-medium justify-center relative shrink-0 text-[32px]">
...
function EnterAddress() {
  return (
    <div className="content-stretch flex gap-[12px] items-center justify-center relative shrink-0 w-full" data-name="enter address">
...
function Left() {
  return (
    <div className="relative shrink-0 w-full" data-name="left">
...
function QuestionExplainer() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start leading-[0] relative shrink-0 text-[#2c4a2e] w-full" data-name="question + explainer">
      <div className="flex flex-col font-['Playfair_Display:Medium',sans-serif] font-medium justify-center relative shrink-0 text-[18px] w-full">
        <h1 className="block leading-[26px]">{`What's your biggest concern about transitioning?`}</h1>
      </div>
      <div className="flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[14px] w-full">
        <h1 className="block leading-[22px]">This helps us understand the infrastructure you have and identify which transition paths make sense.</h1>
      </div>
    </div>
  );
}
...
function Black() {
  return <div className="absolute bg-[#1a1a18] inset-0 opacity-5" data-name="Black" />;
}
...
function Choices() {
  return (
    <div className="content-stretch cursor-pointer flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="choices">
      <button className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Radio Button">
        <RadioButton />
        <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px relative text-[#1a1a18] text-[14px] text-left">
          <p className="leading-[22px]">I’m not sure it’s financially viable</p>
        </div>
      </button>
      <button className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Radio Button">
        <RadioButton1 />
        <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px relative text-[#1a1a18] text-[14px] text-left">
          <p className="leading-[22px]">I have debt tied to my current operation</p>
        </div>
      </button>
      <button className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Radio Button">
        <RadioButton2 />
        <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px relative text-[#1a1a18] text-[14px] text-left">
          <p className="leading-[22px]">I don’t know what I’d grow instead</p>
        </div>
      </button>
      <button className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Radio Button">
        <RadioButton3 />
        <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px relative text-[#1a1a18] text-[14px] text-left">
          <p className="leading-[22px]">Family or community pressure</p>
        </div>
      </button>
      <button className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Radio Button">
        <RadioButton4 />
        <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px relative text-[#1a1a18] text-[14px] text-left">
          <p className="leading-[22px]">I don’t know where I’d sell my crops</p>
        </div>
      </button>
      <button className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Radio Button">
        <RadioButton5 />
        <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px relative text-[#1a1a18] text-[14px] text-left">
          <p className="leading-[22px]">Something else</p>
        </div>
      </button>
    </div>
  );
...
function MajesticonsArrowRight2() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="majesticons:arrow-right">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="majesticons:arrow-right">
...
function Ctas() {
  return (
    <div className="content-stretch flex gap-[16px] items-start justify-center relative shrink-0" data-name="ctas">
      <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0" data-name="tertiary cta - previous">
        <TextIcon />
        <div className="h-0 relative shrink-0 w-full">
          <div className="absolute inset-[-0.7px_-1.21%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 59.4 1.4">
              <path d="M0.7 0.7H58.7" id="Line 1" stroke="var(--stroke-0, #8B6A14)" strokeLinecap="round" strokeWidth="1.4" />
            </svg>
          </div>
        </div>
      </div>
...
function Right() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center py-[16px] relative shrink-0 w-full" data-name="right">
      <div className="[word-break:break-word] flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] min-w-full relative shrink-0 text-[#2c4a2e] text-[18px] text-center w-[min-content]">
        <h1 className="block leading-[26px]">Who can help you right now:</h1>
      </div>
      <Container />
      <Ctas />
    </div>
