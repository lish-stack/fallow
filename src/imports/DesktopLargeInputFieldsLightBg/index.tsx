type DesktopLargeInputFieldsLightBgProps = {
  className?: string;
  property1?: "Default" | "input" | "error" | "focus";
};

export default function DesktopLargeInputFieldsLightBg({ className, property1 = "Default" }: DesktopLargeInputFieldsLightBgProps) {
  if (property1 === "focus") {
    return (
