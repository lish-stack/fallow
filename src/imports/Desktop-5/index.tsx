import svgPaths from "./svg-j1di66uskl";
...
function LogInCta() {
  return (
    <div className="[word-break:break-word] content-stretch flex font-['Source_Sans_3:Regular',sans-serif] font-normal gap-[6px] items-start justify-center leading-[0] relative shrink-0 text-[#f5f0e8] text-[16px] text-center w-full whitespace-nowrap" data-name="log in cta">
      <div className="flex flex-col justify-center relative shrink-0">
        <p className="leading-[24px]">Already have an account?</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0">
        <p className="[text-underline-position:from-font] decoration-from-font decoration-solid leading-[24px] underline">Log in</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-[#2c4a2e] content-stretch flex flex-col gap-[24px] items-center overflow-clip p-[64px] relative rounded-[16px] shrink-0 w-[576px]" data-name="cta section">
      ...
      <div className="[word-break:break-word] flex flex-col font-['Playfair_Display:Medium',sans-serif] font-medium justify-center leading-[0] min-w-full relative shrink-0 text-[#f5f0e8] text-[28px] text-center w-[min-content]">
        <p className="leading-[36px]">Let’s start working on your business plan.</p>
      </div>
      ...
      <div className="[word-break:break-word] flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] min-w-full relative shrink-0 text-[#f5f0e8] text-[20px] text-center w-[min-content]">
        <p className="leading-[28px]">Create your free Fallow account to save your progress and pick up right where you left off.</p>
      </div>
      <button className="bg-[#f5f0e8] cursor-pointer relative rounded-[8px] shrink-0 w-full" data-name="desktop large input fields - dark bg">
        ...
        <div className="content-stretch flex items-start px-[16px] py-[10px] relative size-full">
          <p className="[word-break:break-word] font-['Source_Sans_3:Light',sans-serif] font-light leading-[28px] relative shrink-0 text-[#2c4a2e] text-[20px] text-left whitespace-nowrap">Full name</p>
        </div>
      </button>
      <button className="bg-[#f5f0e8] cursor-pointer relative rounded-[8px] shrink-0 w-full" data-name="desktop large input fields - dark bg">
        <div aria-hidden className="absolute border border-[#969696] border-solid inset-0 pointer-events-none rounded-[8px]" />
      ...
      <button className="bg-[#f5f0e8] cursor-pointer relative rounded-[8px] shrink-0 w-full" data-name="desktop large input fields - dark bg">
        <div aria-hidden className="absolute border border-[#969696] border-solid inset-0 pointer-events-none rounded-[8px]" />
        <div className="content-stretch flex items-start px-[16px] py-[10px] relative size-full">
          <p className="[word-break:break-word] font-['Source_Sans_3:Light',sans-serif] font-light leading-[28px] relative shrink-0 text-[#2c4a2e] text-[20px] text-left whitespace-nowrap">Re-type password</p>
        </div>
      </button>
      <div className="bg-[#8b6a14] content-stretch flex items-center justify-center px-[16px] py-[12px] relative rounded-[12px] shrink-0" data-name="Secondary button - desktop">
        <div className="[word-break:break-word] flex flex-col font-['Source_Sans_3:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#f5f0e8] text-[20px] text-center whitespace-nowrap">
          <p className="leading-[28px]">Create my account</p>
        </div>
      </div>
      <LogInCta />
    </div>
