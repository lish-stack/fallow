import svgPaths from "./svg-1f3pih7fr0";
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start leading-[0] relative shrink-0 text-[#2c4a2e] w-full" data-name="question + explainer">
      <div className="flex flex-col font-['Playfair_Display:Medium',sans-serif] font-medium justify-center relative shrink-0 text-[18px] w-full">
        <h1 className="block leading-[26px]">What are you currently farming?</h1>
      </div>
        ...
        <div className="content-stretch flex flex-col gap-[24px] items-center p-[32px] relative size-full">
          ...
          <button className="bg-[#f5f0e8] cursor-pointer relative rounded-[8px] shrink-0 w-full" data-name="mobile small input fields - light bg">
            ...
            <div className="content-stretch flex items-start px-[10px] py-[8px] relative size-full">
              <p className="[word-break:break-word] font-['Source_Sans_3:Light',sans-serif] font-light leading-[22px] relative shrink-0 text-[#2c4a2e] text-[14px] text-left whitespace-nowrap">E.g. beef cattle, dairy cattle, poultry...</p>
            </div>
          </button>
        </div>
      </div>
...
function Right() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center py-[16px] relative shrink-0 w-full" data-name="right">
      <div className="[word-break:break-word] flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] min-w-full relative shrink-0 text-[#2c4a2e] text-[14px] text-center w-[min-content]">
        <h1 className="block leading-[22px]">We need some more information to complete your assessment:</h1>
      </div>
      <Container />
