import svgPaths from "./svg-gbjrq0t46l";
      ...
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-center px-[24px] py-[20px] relative size-full">
          <div className="[word-break:break-word] flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] min-w-full relative shrink-0 text-[#1a1a18] text-[14px] w-[min-content]">
            <p className="leading-[22px]">{`This assessment is based on your three answers plus regional data for Duplin County. Some details — like acreage and infrastructure — are estimated from what's typical for contract poultry farms in your area. Your actual situation may vary.`}</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="mdi:location">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="mdi:location">
          <path d={svgPaths.p3aac8400} fill="var(--fill-0, #2C4A2E)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function HeadSubhead() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0 w-full" data-name="head + subhead">
      <MdiLocation />
      <div className="[word-break:break-word] flex flex-col font-['Playfair_Display:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#2c4a2e] text-[24px] text-center whitespace-nowrap">
        <h1 className="block leading-[32px]">Duplin County, NC</h1>
      </div>
    </div>
  );
}
...
function Group() {
  return (
    <div className="absolute inset-[11.27%_12.71%_8.33%_12.31%]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.9956 19.295">
        <g id="Group">
          <path d={svgPaths.p36650b00} fill="var(--fill-0, #8B6A14)" id="Vector" />
          <path clipRule="evenodd" d={svgPaths.p223b6260} fill="var(--fill-0, #8B6A14)" fillRule="evenodd" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function HealthiconsAnimalChickenOutline() {
  return (
    <div className="overflow-clip relative shrink-0 size-[24px]" data-name="healthicons:animal-chicken-outline">
      <Group />
    </div>
  );
}
...
function Type() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="type">
      ...
      <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px relative text-[#8b6a14] text-[18px]">
        <p className="leading-[26px]">Contract poultry</p>
      </div>
    </div>
  );
}
    ...
    <div className="absolute inset-[8.33%_12.5%]" data-name="Group">
      <div className="absolute inset-[-3.75%_-4.17%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.5 21.5">
          <g id="Group">
            <path d={svgPaths.p3ae90880} id="Vector" stroke="var(--stroke-0, #C4432A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            <path d={svgPaths.p16796500} id="Vector_2" stroke="var(--stroke-0, #C4432A)" strokeLinejoin="round" strokeWidth="1.5" />
            <path d={svgPaths.pb617ef0} id="Vector_3" stroke="var(--stroke-0, #C4432A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          </g>
        </svg>
      </div>
    </div>
...
function HugeiconsMoneyBag() {
  return (
    <div className="overflow-clip relative shrink-0 size-[24px]" data-name="hugeicons:money-bag-02">
      <Group1 />
    </div>
  );
}
...
function Concern() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="concern">
      <HugeiconsMoneyBag />
      <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px relative text-[#c4432a] text-[18px]">
        <p className="leading-[26px]">Debt tied to current operation</p>
      </div>
    </div>
  );
}
...
function Tag() {
  return (
    <div className="bg-[#d9d2c4] content-center flex flex-wrap gap-[8px] items-center justify-center px-[12px] py-[8px] relative rounded-[24px] shrink-0" data-name="tag">
...
function Left() {
  return (
    <div className="h-[608px] relative shrink-0 w-full" data-name="left">
    ...
    <div className="relative shrink-0 w-full" data-name="summary">
      ...
      <div className="flex flex-col items-center justify-center size-full">
        <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-center justify-center leading-[0] px-[32px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Source_Sans_3:Medium',sans-serif] font-medium justify-center relative shrink-0 text-[#2c4a2e] text-[24px] w-full">
            <p className="leading-[32px]">What we know about your land</p>
          </div>
    ...
    <div className="relative shrink-0 size-[24px]" data-name="mdi:emoticon-happy-outline">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="mdi:emoticon-happy-outline">
          <path d={svgPaths.p1cafa280} fill="var(--fill-0, #2C4A2E)" id="Vector" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="bg-[#e9f0ea] relative rounded-[8px] shrink-0 w-full" data-name="readiness status">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[10px] py-[8px] relative size-full">
          ...
          <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px relative text-[#2c4a2e] text-[18px]">
            <p className="leading-[26px]">Moderately ready</p>
          </div>
        </div>
      </div>
    </div>
...
function Left1() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="left">
      <LandSuitability />
      <Infrastructure />
    </div>
  );
...
function Right1() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="right">
      <FinancialPosition />
      <MarketAccess />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="readiness">
      <div className="content-stretch flex flex-col gap-[12px] items-start p-[24px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#2c4a2e] text-[20px] w-full">
          <p className="leading-[28px]">Transition readiness</p>
        </div>
        <ReadinessStatus />
        <All />
      </div>
...
function Right() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-full" data-name="right">
      <Summary />
      <Readiness />
    </div>
  );
...
function Overview() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="overview">
      <Left />
      <Right />
    </div>
  );
...
function R() {
  return (
    <div className="content-stretch flex flex-col items-start justify-between relative self-stretch shrink-0 text-[#2c4a2e] text-[14px]" data-name="r1">
...
function R1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-center min-w-px relative text-[#1a1a18] text-[12px] text-right" data-name="r2">
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[20px]">$3,000 - $6,000 per month</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[20px]">4 - 6 months</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[20px]">$12,000 - $18,000</p>
      </div>
    </div>
  );
}
...
function Card() {
  return (
    <article className="bg-[#d9d2c4] relative rounded-[16px] shrink-0 w-full" data-name="Card 1">
...
function R2() {
  return (
    <div className="content-stretch flex flex-col items-center justify-between relative self-stretch shrink-0 text-[#2c4a2e] text-[14px] w-[126px]" data-name="r1">
      <div className="flex flex-col h-[18px] justify-center relative shrink-0 w-full">
        <p className="leading-[18px]">earning potential</p>
      </div>
      <div className="flex flex-col h-[22px] justify-center relative shrink-0 w-full">
        <p className="leading-[18px]">time to income</p>
      </div>
      <div className="flex flex-col h-[22px] justify-center relative shrink-0 w-full">
        <p className="leading-[18px]">est. conversion cost</p>
...
function R3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-center min-w-px relative text-[#1a1a18] text-[12px] text-right" data-name="r2">
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[20px]">$1,500 - $3,500 per month</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[20px]">6 - 8 weeks</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[20px]">$4,000 - $8,000</p>
      </div>
    </div>
  );
}
...
function Stats1() {
  return (
    <div className="relative shrink-0 w-full" data-name="stats">
      <div className="[word-break:break-word] content-stretch flex font-['Source_Sans_3:Regular',sans-serif] font-normal items-start leading-[0] p-[8px] relative size-full">
        <R2 />
        <R3 />
      </div>
    </div>
...
function Card1() {
  return (
    <article className="bg-[#d9d2c4] relative rounded-[16px] shrink-0 w-full" data-name="Card 4">
      <div className="content-stretch flex flex-col items-start justify-center overflow-clip relative rounded-[inherit] size-full">
        <Body1 />
      </div>
      <div aria-hidden className="absolute border-[#2c4a2e] border-[1.4px] border-solid inset-0 pointer-events-none rounded-[16px]" />
...
function R4() {
  return (
    <div className="content-stretch flex flex-col items-start justify-between relative self-stretch shrink-0 text-[#2c4a2e] text-[14px] w-[126px]" data-name="r1">
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[18px]">earning potential</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
...
function R5() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-end min-w-px relative text-[#1a1a18] text-[12px] text-right" data-name="r2">
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[20px]">$4,000 - $8,000 per acre</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[20px]">2 - 3 years</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[20px]">$8,000 - $12,000 per acre</p>
      </div>
    </div>
  );
}
...
function Card2() {
  return (
    <article className="bg-[#d9d2c4] relative rounded-[16px] shrink-0 w-full" data-name="Card 5">
      <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
        <Body2 />
      </div>
      <div aria-hidden className="absolute border-[#2c4a2e] border-[1.4px] border-solid inset-0 pointer-events-none rounded-[16px]" />
    ...
    <div className="max-w-[773px] relative shrink-0 w-full" data-name="summary">
      ...
      <div className="flex flex-col items-center justify-center max-w-[inherit] size-full">
        <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-center justify-center leading-[0] max-w-[inherit] px-[24px] py-[4px] relative size-full">
          <div className="flex flex-col font-['Source_Sans_3:Medium',sans-serif] font-medium justify-center relative shrink-0 text-[#c4432a] text-[20px] w-full">
            <p className="leading-[28px]">Your biggest obstacle is debt tied to your current operation</p>
          </div>
          <div className="flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[#1a1a18] text-[16px] w-full whitespace-pre-wrap">
            <p className="leading-[24px] mb-0">{`Most contract poultry farmers in your situation carry equipment debt that's tied directly to their integrator relationship — meaning Tyson, Perdue, or whoever you contract with has to authorize any changes to your operation before you can act. This isn't a dead end. `}</p>
            <p className="leading-[24px] mb-0">​</p>
            <p className="leading-[24px] mb-0">Thousands of farmers have navigated this exact situation and come out the other side. But it has to be the first thing you address.</p>
            <p className="leading-[24px] mb-0">​</p>
            <p className="leading-[24px]">{`Before you do anything else, request a full copy of your contract and identify exactly who holds your equipment debt. You don't have to figure this out alone.`}</p>
          </div>
        </div>
      </div>
    </div>
...
function Body4() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-start leading-[0] relative shrink-0 w-full" data-name="Body">
      <div className="flex flex-col font-['Source_Sans_3:Medium',sans-serif] font-medium justify-center relative shrink-0 text-[#2c4a2e] text-[18px] w-full">
        <h5 className="block leading-[26px]">Transfarmation Project</h5>
      </div>
...
function Resource() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 w-full" data-name="resource">
      <div className="[word-break:break-word] flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#2c4a2e] text-[16px] text-center w-full">
        <p className="leading-[24px]">Here’s a free resource to check out:</p>
      </div>
      <Transfarmation />
    </div>
  );
...
function Section() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-center py-[16px] relative shrink-0 w-full" data-name="section">
      <Summary1 />
    ...
    <div className="bg-[#2c4a2e] relative rounded-[16px] shrink-0 w-full" data-name="cta section">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[24px] items-center p-[32px] relative size-full">
          <div className="[word-break:break-word] flex flex-col font-['Source_Sans_3:Medium',sans-serif] font-medium justify-center leading-[0] min-w-full relative shrink-0 text-[#d9d2c4] text-[18px] text-center w-[min-content]">
            <p className="leading-[26px]">We’ve assessed your land.</p>
          </div>
          <div className="[word-break:break-word] flex flex-col font-['Playfair_Display:Medium',sans-serif] font-medium justify-center leading-[0] min-w-full relative shrink-0 text-[#f5f0e8] text-[24px] text-center w-[min-content]">
            <p className="leading-[32px]">Now let’s turn it into a plan that unlocks funding.</p>
          </div>
          <div className="h-0 relative shrink-0 w-full">
            <div className="absolute inset-[-0.8px_0_0_0]">
          ...
          <div className="[word-break:break-word] flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] min-w-full relative shrink-0 text-[#f5f0e8] text-[16px] text-center w-[min-content]">
            <p className="leading-[24px]">{`Most transition grants — including USDA EQIP and the Transfarmation R&I Grant — require a basic business plan. Fallow builds it with you, section by section, using everything we already know about your land. It takes about 20 minutes and gives you a document you can submit directly.`}</p>
          </div>
          <div className="bg-[#8b6a14] content-stretch flex items-center justify-center px-[14px] py-[10px] relative rounded-[12px] shrink-0" data-name="Secondary button - mobile">
            <div className="[word-break:break-word] flex flex-col font-['Source_Sans_3:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#f5f0e8] text-[16px] text-center whitespace-nowrap">
              <p className="leading-[24px]">Start my plan</p>
            </div>
          </div>
        </div>
      </div>
