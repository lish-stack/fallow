...
function DLanding({ navigate }: { navigate: (p: Page) => void }) {
  ...
  return (
    <div className="content-stretch flex flex-col items-center relative min-h-screen w-full">
      ...
      <section className="content-stretch flex flex-col gap-[32px] items-center overflow-clip pt-[128px] px-[56px] pb-[56px] relative shrink-0 w-full">
        ...
        <div className="bg-[#2c4a2e] content-stretch flex flex-col gap-[24px] items-center overflow-clip px-[128px] py-[48px] relative rounded-[16px] shrink-0 w-full max-w-[970px]">
          ...
          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
            ...
            <p className="font-['Source_Sans_3:Regular',sans-serif] text-[#b8cdb9] text-[13px] leading-[18px] px-[4px]">We only use this to generate your assessment — we never sell or share your information.</p>
            {geoLoading && (
      ...
      <DHeader btnLabel="Log in" onBtn={() => navigate("login")} onLogoClick={() => navigate("landing")} />
    </div>
  );
}
            ...
            <div className="bg-[#d9d2c4] relative rounded-[12px] shrink-0 w-full">
              <div className="content-stretch flex gap-[8px] items-start p-[16px] relative size-full">
                ...
                <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px relative text-[#1a1a18] text-[16px]">
                  <p className="leading-[24px]">{`This assessment was generated by AI based on your three answers and general regional knowledge for ${countyLabel} — it isn't a substitute for advice from a local agronomist, lender, or extension office. Some details, like acreage and infrastructure, are estimated from what's typical for ${farmType.toLowerCase()} farms in your area. Always verify specifics before making major decisions.`}</p>
                </div>
              </div>
            </div>
                      ...
                      <div className="relative shrink-0 w-full">
                        <div className="flex flex-col justify-start size-full">
                          <div className="content-stretch flex flex-col gap-[24px] items-start justify-start p-[24px] relative size-full">
                            ...
                            <div className="relative shrink-0 w-full">
                              <div className="[word-break:break-word] flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal gap-[10px] leading-[0] px-[8px] pt-[8px] pb-[16px] relative size-full text-[14px]">
      ...
      <section className="relative shrink-0 w-full">
        <div className="content-stretch flex flex-col items-center pb-[56px] pt-[128px] px-[56px] relative size-full">
          <div className="bg-[#2c4a2e] content-stretch flex flex-col gap-[24px] items-center overflow-clip p-[64px] relative rounded-[16px] shrink-0 w-[576px]">
            ...
            <p className="font-['Source_Sans_3:Regular',sans-serif] text-[#b8cdb9] text-[13px] leading-[18px] text-center w-full">No spam, no sales calls — ever. We never sell or share your information.</p>
...
function MLanding({ navigate }: { navigate: (p: Page) => void }) {
  ...
  return (
    <div className="content-stretch flex flex-col items-center relative min-h-screen w-full">
            ...
            <div className="bg-[#2c4a2e] content-stretch flex flex-col gap-[24px] items-center overflow-clip px-[24px] py-[32px] relative rounded-[16px] shrink-0 w-[343px]">
              ...
              <div className="content-stretch flex flex-col gap-[12px] items-center justify-center relative shrink-0 w-full">
                ...
                <button
                  onClick={handleStart}
                  disabled={geoLoading}
                  className="bg-[#f5f0e8] hover:bg-[#8b6a14] group content-stretch flex items-center p-[8px] relative rounded-[40px] shrink-0 border border-[#8b6a14] cursor-pointer transition-colors disabled:opacity-60 disabled:cursor-default"
                >
                  <div className="relative shrink-0 size-[16px]">
                    <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
                ...
                <p className="font-['Source_Sans_3:Regular',sans-serif] text-[#b8cdb9] text-[12px] leading-[16px] text-center px-[8px]">We only use this to generate your assessment — we never sell or share your information.</p>
                {geoLoading && (
                  <p className="font-['Source_Sans_3:Regular',sans-serif] text-[#d9d2c4] text-[13px] leading-[18px]">Finding your farm...</p>
                )}
                {geoError && (
                  <p className="font-['Source_Sans_3:Regular',sans-serif] text-[#ffb4a8] text-[13px] leading-[18px] text-center">{geoError}</p>
                )}
              </div>
            </div>
          </div>
      ...
      <MHeader btnLabel="Log in" onBtn={() => navigate("login")} onLogoClick={() => navigate("landing")} />
    </div>
  );
}
              ...
              <div className="flex flex-col items-center size-full">
                <div className="content-stretch flex flex-col gap-[8px] items-center px-[24px] py-[20px] relative size-full">
                  <div className="[word-break:break-word] flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] min-w-full relative shrink-0 text-[#1a1a18] text-[14px] w-[min-content]">
                    <p className="leading-[22px]">{`This assessment was generated by AI based on your three answers and general regional knowledge for ${countyLabel} — it isn't a substitute for advice from a local agronomist, lender, or extension office. Some details, like acreage and infrastructure, are estimated from what's typical for ${farmType.toLowerCase()} farms in your area. Always verify specifics before making major decisions.`}</p>
                  </div>
                </div>
              </div>
            </div>
                            ...
                            <div className="relative shrink-0 w-full">
                              <div className="[word-break:break-word] flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal gap-[10px] leading-[0] px-[8px] pt-[8px] pb-[16px] relative size-full text-[14px]">
                                <div className="flex items-start justify-between gap-[12px]">
                                  <span className="shrink-0 text-[#2c4a2e] leading-[18px]">Earning potential</span>
                                  <span className="text-right text-[#1a1a18] text-[12px] leading-[20px]">{crop.earningPotential}</span>
                                </div>
                                <div className="flex items-start justify-between gap-[12px]">
                                  <span className="shrink-0 text-[#2c4a2e] leading-[18px]">Time to income</span>
                                  <span className="text-right text-[#1a1a18] text-[12px] leading-[20px]">{crop.timeToIncome}</span>
                                </div>
                                <div className="flex items-start justify-between gap-[12px]">
                                  <span className="shrink-0 text-[#2c4a2e] leading-[18px]">Est. conversion cost</span>
                                  <span className="text-right text-[#1a1a18] text-[12px] leading-[20px]">{crop.conversionCost}</span>
                                </div>
                              </div>
                            </div>
                          </div>
